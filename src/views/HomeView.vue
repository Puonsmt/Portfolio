    ...
    <v-container fluid>
      <div class="head">
        <v-row>
          ...
          <v-col cols="5">
            <div style="position: relative;z-index: 9999;bottom:40;margin-left: auto;margin-right: auto;left:90;right:0;">
              <v-img src="@/assets/avt2.png" contain max-height="400"></v-img>
            </div>
          </v-col>
        </v-row>
      </div>
      <v-col ccols="12" class="mt-16" id="about">
        <div>
          <v-row>
            <v-col cols="12" sm="6">
              <div class="egg">
                <v-img src="@/assets/avt4(1)(1).png" contain max-height="250" style="position: relative; top: 50px;"></v-img>
              </div>
            </v-col>
            <v-col cols="12" sm="6">
          ...
          <v-row>
            <v-col cols="12">
              <div class="child">
                ...
                <h3 class="ml-3 mt-4">Language</h3>
                <p class="text-grey ml-3 mt-4 text-captopn">
                  C/C++, Java, Python                      <br/>
              ...
              <div class="child">
                ...
                <h3 class="ml-3 mt-4">Other</h3>
                <p class="text-grey ml-3 mt-4 text-captopn">
                  Basic understanding of OOP <br />
                  methodologies, Data structures and <br />
                  algorithms.Word, Excel, Powerpoint
                </p>
              </div>
            </v-col>
          </v-row>
      ...
      <v-col cols="12" sm="12" id="project">
        <div class="d-flex justify-center mb-6">
          ...
          <v-btn color="#FBDF7E" variant="tonal">Web Developer</v-btn>
          <v-btn color="#FBDF7E" variant="tonal">Photography</v-btn>
          <v-btn color="#FBDF7E" variant="tonal">App Design</v-btn>
        </div>
      </v-col>
      ...
      <v-col cols="12" id="project">
        <div class="pre">
          <v-row>
            <v-col cols="12" sm="4">
              <v-card class="mw-auto" max-width="344" height="">
                <v-img src="@/assets/avt3.jpg" height="200px" cover></v-img>
                <v-card-title>We are provide you the best</v-card-title>
                <v-card-subtitle>
        ...
        <v-row>
          <v-col cols="12" sm="4">
            <div class="child">
              ...
              <span class="text-caption">Your Street SYO, Your Area Bream</span><br />
              <v-btn icon="fas fa-phone-alt" class="mt-10" variant="outlined"></v-btn><br />
              <span class="text-caption">0023-6547</span><br />
              <v-btn icon="fas fa-envelope" class="mt-10" variant="outlined"></v-btn><br />
              <span class="text-caption">trphuong23@gmail.com</span><br />
            </div>
          </v-col>
          <v-col cols="12" sm="8">
...
export default defineComponent({
  ...
  items: [
    {
      img: require('@/assets/avt1.png'),
    },
    {
      img: require('@/assets/avt2.png'),
    },
    {
      img: require('@/assets/avt4(1)(1).png'),
    },
    {
      img: require('@/assets/avt3.jpg'),
    },
    {
      img: require('@/assets/avt4.png'),
    },
    {
      img: require('@/assets/avt4(1)(1).png'),
    },
